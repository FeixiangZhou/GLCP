...
class DC_and_CE_and_CBDC_loss(nn.Module):
    ...
    def forward(self, net_output: torch.Tensor, target: torch.Tensor, t_skeletonize_flage=False):
        ...
        # print('self.weight_ce, weight_dice, weight_cbdice-------', self.weight_ce, self.weight_dice, self.weight_cbdice)
        # print('DC_and_CE_and_CBDC_loss-------', result)
        return result
...
class DC_and_CE_and_CL_M_DC_loss(nn.Module):
    ...
    def forward(self, net_output: torch.Tensor, target: torch.Tensor, t_skeletonize_flage=False):
        ...
        print('DC_and_CE_and_CL_M_DC_loss-------', result)
        return result
