...
def get_trainer_from_args(dataset_name_or_id: Union[int, str],
    ...
    print("run—training-plans_file----------",plans_file)
...
def run_training(dataset_name_or_id: Union[str, int],
    ...
    if num_gpus > 1:
        ...
        if not only_run_validation:
            nnunet_trainer.run_training(nnunet_trainer)

        # if val_with_best:
            # nnunet_trainer.load_checkpoint(join(nnunet_trainer.output_folder, 'checkpoint_best.pth'))
            # nnunet_trainer.load_checkpoint(join(nnunet_trainer.output_folder, 'checkpoint_188.pth'))
        ...
        #         print(join(nnunet_trainer.output_folder, 'checkpoint_%d.pth' % (199-i)))
        #         nnunet_trainer.load_checkpoint(join(nnunet_trainer.output_folder, 'checkpoint_%d.pth' % (199-i)))
        #         nnunet_trainer.perform_actual_validation(export_validation_probabilities)
