import numpy as np
from nnunetv2.training.loss.compound_cldice_loss_2dunet import DC_and_CE_and_CLDC_loss
from nnunetv2.training.loss.dice import MemoryEfficientSoftDiceLoss
from nnunetv2.training.nnUNetTrainer.variants.network_architecture.nnUNetTrainer_2DUnet_NoDeepSupervision import nnUNetTrainer_2DUnet_NoDeepSupervision

class nnUNetTrainer_2DUnet_NoDeepSupervision_CE_DC_crit_ske_con_refine(nnUNetTrainer_2DUnet_NoDeepSupervision):
