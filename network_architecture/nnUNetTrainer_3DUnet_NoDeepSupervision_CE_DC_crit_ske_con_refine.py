import numpy as np
from nnunetv2.training.loss.compound_cldice_loss_3dunet import DC_and_CE_and_CLDC_loss
...
class nnUNetTrainer_3DUnet_NoDeepSupervision_CE_DC_crit_ske_con_refine(nnUNetTrainer_3DUnet_NoDeepSupervision):
