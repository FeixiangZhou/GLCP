...
class nnUNetTrainer_3DUnet_NoDeepSupervision_CE_cbDC2(nnUNetTrainer_3DUnet_NoDeepSupervision):
    ...
    def _build_loss(self):
        ...
        loss = DC_and_CE_and_CBDC_loss({'batch_dice': self.configuration_manager.batch_dice, 'smooth': 1e-5, 'do_bg': False, 'ddp': self.is_ddp}, {},
                                    {'iter_': 10, 'smooth': 1e-3},weight_ce=lambda_ce, weight_dice=lambda_dice, weight_cbdice=lambda_cbdice, ignore_label=self.label_manager.ignore_label, dice_class=MemoryEfficientSoftDiceLoss)
